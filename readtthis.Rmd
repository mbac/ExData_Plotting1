...
Code for plots is contained in this section for readability. .R script files are also provided as requested by the assignment.
...
dev.print(device = png, width = 480, height = 480, units = "pixels")
